...
**What actually works:** Attach the work to an initiative that already has money. Today's strongest disguise is AI — "for the AI model to work you need to feed it quality data — surprise." (course day 2, transcript). Name the pain, not the discipline: one mid-size peer sold it as "DG as a service unblocking business initiatives" and funded a 3-person team off an Excel of small monetized cases (course day 2, slides p.41-43). And watch every word: even "certification" "smells of bureaucracy" to some audiences — consider another term before you brand the programme with it (course day 3, transcript); "data management sync" is received better than "committee" and works identically (course day 5, transcript).
