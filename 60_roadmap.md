...
**A9. No worked example of a populated catalog or glossary.** *(Partially addressed: `80_examples/` now carries two complete strategy runs, which closes the same class of gap for the strategy artefact. The catalog and glossary examples are still missing and are what this entry is about.)*
