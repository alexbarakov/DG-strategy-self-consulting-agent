...
- The question that kills weak cases: "they ask — what share of this are you ready to save *provably*, over a year, two, three? And you most likely don't know. You will have to promise something. And if it doesn't come true, you take a defeat in management's eyes — or in the end, get fired. I am in that situation right now." His own number, disclosed as a warning: "my whole DG slice brings the company about 11M RUB a month — very little for a company that size." (course day 6, transcript)
...
8. **Peer archetypes.** Bottom-up on platform-head will, no CDO (Yandex Taxi). No calm period because the org re-transforms quarterly (Ozon). Culture that rejects imposed rules and roles (Tinkoff). Top-down request on DQ, InfoSec as locomotive (VK). Justified through metric discrepancies (hh). Find the one you resemble before designing anything. (course day 2, slides p.54; day 6, slides p.107)
